...
const StressAndLifeStyleRaange = ({onChangeData}) => {

  const [left, setLeft] = useState(0)
  const [value, setValue] = useState(1)
  const valueBubbleRef1 = useRef(null);
      ...
      <div className="field">
        <div className='slider'>
          ...
          <div className='slider-input'>
            ...
            <div ref={valueBubbleRef1} className='field_range-cirkule'>{value}</div>
          </div>
          {
            (
...
export default StressAndLifeStyleRaange